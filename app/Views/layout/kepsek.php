...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        <a class="nav-link" href="<?= route_to('kepsek.berita.index'); ?>">
          <i class="fas fa-fw fa-table"></i>
          <span>Berita</span></a>
      </li>

      <li class="nav-item">
        <a class="nav-link" href="<?= route_to('kepsek.pendaftar.index'); ?>">
          <i class="fas fa-fw fa-user-plus"></i>
          <span>Data Pendaftar</span></a>
      </li>

      <!-- <li class="nav-item">
        <a class="nav-link" href="<?= route_to('kepsek.pembayaran.index'); ?>">
          <i class="fas fa-fw fa-table"></i>
