  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3">PAUD KK</div>
      </a>
      ...
      <!-- <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="<?= route_to('form.murid'); ?>">Data Diri Murid</a>
            <a class="collapse-item" href="<?= route_to('form.ortu'); ?>">Data Orang Tua</a>
          </div>
        </div>
      </li> -->

      <li class="nav-item">
        <a class="nav-link" href="<?= route_to('form.murid'); ?>">
          <i class="fas fa-fw fa-file"></i>
          <span>Formulir Pendaftaran</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="<?= route_to('form.dokumen'); ?>">
          <i class="fas fa-fw fa-upload"></i>
          <span>Berkas</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="<?= route_to('form.pembayaran'); ?>">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          <h5>Halaman Pendaftaran PAUD Kangguru Kecil</h5>
