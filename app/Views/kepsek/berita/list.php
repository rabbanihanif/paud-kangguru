...
<div class="card">
  <div class="card-header text-right">
    <a name="" id="" class="btn btn-primary btn-sm" href="<?= route_to('kepsek.berita.create'); ?>" role="button">
      ...
      <tbody>
        <?php foreach ($data as $d) : ?>
          <tr>
            ...
            <td>
              <form action="<?= route_to('kepsek.berita.destroy'); ?>" method="post">
                <?= csrf_field() ?>
                <input type="hidden" name="_method" value="DELETE" />
                <input type="hidden" name="id_berita" value="<?= $d->id_berita; ?>" />
                <a class="btn btn-primary btn-sm" href="<?= route_to('kepsek.berita.edit', $d->id_berita); ?>" role="button">Ubah</a>
