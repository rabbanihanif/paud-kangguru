...
<div class="row mb-3">
  <div class="col-md-12 text-right">
    <a name="" id="" class="btn btn-dark btn-sm" href="<?= route_to('kepsek.pendaftar.index'); ?>" role="button">
      <i class="fa fa-arrow-left" aria-hidden="true"></i>
      Kembali
    </a>
    <a name="" id="" class="btn btn-success btn-sm" href="<?= route_to('kepsek.pendaftar.print', $murid->id_murid); ?>" role="button" target="_blank">
    ...
    <div class="card mb-3">
      ...
      <div class="card-body">
        ...
        <div class="row mb-3">
          <div class="col-md-12">
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="nama" id="nama" aria-describedby="nama" placeholder="Nama" value="<?= set_value('nama', $ortu->nama) ?>" readonly disabled>
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
              <label for="nik">NIK</label>
              <input type="text" class="form-control" name="nik" id="nik" aria-describedby="nik" placeholder="NIK" value="<?= set_value('nik', $ortu->nik) ?>" readonly disabled>
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
              <label for="telepon">Nomor Telepon</label>
              <input type="text" class="form-control" name="telepon" id="telepon" aria-describedby="telepon" placeholder="Nomor telepon" value="<?= set_value('telepon', $ortu->telepon) ?>" readonly disabled>
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
              <label for="pendidikan">Pendidikan</label>
              <input type="text" class="form-control" name="pendidikan" id="pendidikan" aria-describedby="pendidikan" placeholder="Pendidikan" value="<?= set_value('pendidikan', $ortu->pendidikan) ?>" readonly disabled>
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
              <label for="pekerjaan">Pekerjaan</label>
              <input type="text" class="form-control" name="pekerjaan" id="pekerjaan" aria-describedby="pekerjaan" placeholder="Pekerjaan" value="<?= set_value('pekerjaan', $ortu->pekerjaan) ?>" readonly disabled>
            </div>
          </div>
        </div>
        ...
        <div class="row mb-3">
          <div class="col-md-12">
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="nama_ibu" id="nama_ibu" aria-describedby="nama_ibu" placeholder="Nama" value="<?= set_value('nama_ibu', $ortu->nama_ibu) ?>" readonly disabled>
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
              <label for="nik_ibu">NIK</label>
              <input type="text" class="form-control" name="nik_ibu" id="nik_ibu" aria-describedby="nik_ibu" placeholder="NIK" value="<?= set_value('nik_ibu', $ortu->nik_ibu) ?>" readonly disabled>
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
              <label for="telepon_ibu">Nomor Telepon</label>
              <input type="text" class="form-control" name="telepon_ibu" id="telepon_ibu" aria-describedby="telepon_ibu" placeholder="Nomor telepon" value="<?= set_value('telepon_ibu', $ortu->telepon_ibu) ?>" readonly disabled>
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
              <label for="pendidikan_ibu">Pendidikan</label>
              <input type="text" class="form-control" name="pendidikan_ibu" id="pendidikan_ibu" aria-describedby="pendidikan_ibu" placeholder="Pendidikan" value="<?= set_value('pendidikan_ibu', $ortu->pendidikan_ibu) ?>" readonly disabled>
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
              <label for="pekerjaan_ibu">Pekerjaan</label>
              <input type="text" class="form-control" name="pekerjaan_ibu" id="pekerjaan_ibu" aria-describedby="pekerjaan_ibu" placeholder="Pekerjaan" value="<?= set_value('pekerjaan_ibu', $ortu->pekerjaan_ibu) ?>" readonly disabled>
            </div>
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="penghasilan_ortu" id="penghasilan_ortu" aria-describedby="penghasilan_ortu" placeholder="Penghasilan per bulan" value="<?= set_value('penghasilan_ortu', $ortu->penghasilan_ortu) ?>" readonly disabled>
        </div>
      </div>
    </div>
    <div class="card">
