          ...
          <tr>
            ...
            <td>
              <?php if ($d->status == "Lapor bayar") : ?>
                <a class="btn btn-success btn-sm" href="<?= route_to('kepsek.pembayaran.terima', $d->id_pembayaran); ?>" role="button">Terima</a>
                <a class="btn btn-danger btn-sm" href="<?= route_to('kepsek.pembayaran.tolak', $d->id_pembayaran); ?>" role="button">Tolak</a>
              <?php else : ?>
                &nbsp;
              <?php endif; ?>
            </td>
