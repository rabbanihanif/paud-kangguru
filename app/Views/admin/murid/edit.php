...
<form action="<?= route_to('murid.update', $murid->id_murid); ?>" method="post" enctype="multipart/form-data" class="needs-validation" novalidate="">
  ...
  <a name="" id="" class="btn btn-dark btn-sm mb-4" href="<?= route_to('murid.index'); ?>" role="button">
  ...
  <div class="card col-6">
    <div class="card-body">
      ...
      <div class="row">
        ...
        <!-- <div class="col-md-4">
          <div class="form-group">
            <label for="umur_murid">Umur</label>
            <input type="text" class="form-control" name="umur_murid" id="umur_murid" aria-describedby="umur_murid" placeholder="Umur" value="<?= set_value('umur_murid', $murid->umur_murid); ?>" required>
            <div class="invalid-feedback">
              Field ini harus diisi
            </div>
          </div>
        ...
        <!-- <div class="col-md-4">
          <div class="form-group">
            <label for="umur_murid">Umur</label>
            <select class="form-control" name="umur_murid" id="umur_murid" required>
              <option value="">--Umur--</option>
              <option value="3" <?= set_select('umur_murid', '3') ?> <?= ($murid->umur_murid == '3') ? "selected" : ""; ?>>3 Tahun</option>
              <option value="4" <?= set_select('umur_murid', '4') ?> <?= ($murid->umur_murid == '4') ? "selected" : ""; ?>>4 Tahun</option>
              <option value="5" <?= set_select('umur_murid', '5') ?> <?= ($murid->umur_murid == '5') ? "selected" : ""; ?>>5 Tahun</option>
            </select>
            <div class="invalid-feedback">
              Field ini harus diisi
            </div>
