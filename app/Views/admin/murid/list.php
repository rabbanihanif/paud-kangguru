      ...
      <tbody>
        ...
        <?php foreach ($data as $d) : ?>
          ...
          <tr>
            ...
            <td>
              <form action="<?= route_to('murid.destroy'); ?>" method="post">
                <?= csrf_field() ?>
                <input type="hidden" name="_method" value="DELETE" />
                <input type="hidden" name="id_murid" value="<?= $d->id_murid; ?>" />
                <a class="btn btn-primary btn-sm" href="<?= route_to('murid.edit', $d->id_murid); ?>" role="button">Ubah</a>
