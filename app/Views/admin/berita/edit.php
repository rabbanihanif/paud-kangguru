  ...
  <div class="section-body">
    <div class="card">
      <div class="card-header text-right">
        <a name="" id="" class="btn btn-dark btn-sm" href="<?= route_to('berita.index'); ?>" role="button">
      ...
      <div class="card-body">
        ...
        <form action="<?= route_to('berita.update', $data->id_berita); ?>" method="post" enctype="multipart/form-data">
          <?= csrf_field() ?>
