                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <label for="umur">
                                ...
                                // Umur saat ini..
                                ?>
                                <h5><span class="badge badge-pill badge-info"> Umur : <?= $age->format("%y"); ?></> Tahun</span></h5>
                            </label>
                        </div>
                    </div>
                    <!-- <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="umur_murid" id="umur_murid" readonly disabled>
