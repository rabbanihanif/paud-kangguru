<?php
    ...
    $this->setCssFile($this->_assetsFolder.'css/grocery-crud-v2.9.4.bf6f5dc.css');
    ...
    $this->setJavaScriptFile($this->_assetsFolder . 'js/build/grocery-crud-v2.9.4.bf6f5dc' . $minify_or_not . '.js');
